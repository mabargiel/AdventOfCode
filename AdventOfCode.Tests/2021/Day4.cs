...
22 11 13  6  5
 2  0 12  3  7";
            ...
            input.ChosenNumbers.ShouldBe(new[]
        ...
        {
            var input = new BingoGame(@"7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1
...
22 11 13  6  5
 2  0 12  3  7");
    ...
    public class Day4_BoardTests
    {
        ...
        {
            var board = new Board(@"22 13 17 11  0
 8  2 23  4 24
21  9 14 16  7
 6 10  3 18  5
 1 12 20 15 19");
        ...
        [Test]
        [TestCase(new [] {21, 9, 16, 3, 12, 14, 16, 18, 7}, 300 - (21 + 9 + 16 + 3 + 12 + 14 + 18 + 7))]
        [TestCase(new [] {8, 21, 6, 1, 22}, 300 - (8 + 21 + 6 + 1 + 22))]
        public void MarkValue_WhenRowOrColumnMarked_IsBingo(int[] valuesMarkingSimulation, int expectedBingoScore)
        {
            var board = new Board(@"22 13 17 11  0
 8  2 23  4 24
21  9 14 16  7
