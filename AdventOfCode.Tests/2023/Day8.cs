...
public class Day8
{
    ...
    public void ParseRawInput_IntoLogicalObject()
    {
        ...
        input.ShouldBeEquivalentTo(new NavigationMap("RL", new Dictionary<string, LeftRight>
        {
            ["AAA"] = new("BBB", "CCC"),
            ["BBB"] = new("DDD", "EEE"),
            ["CCC"] = new("ZZZ", "GGG")
    ...
    [TestCase("""
              ...
              XXX = (XXX, XXX)
              """, 6L)]
    public void Part2_WithExampleInput_CalculateTotalSteps_OfAllPathsStartingAtANodeToZNode(string input,
        long expectedResult)
    {
        var parsedInput = _day8.ParseRawInput(input);
