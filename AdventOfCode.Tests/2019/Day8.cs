...
namespace AdventOfCode.Tests._2019
{
    public class Day8
    {
        ...
        {
            var d8 = new AdventOfCode._2019._8.Day8(imageData, width, height);
        ...
        {
            Assert.Throws<ArgumentException>(() => new AdventOfCode._2019._8.Day8("102111729002123123", width, height));
        }
