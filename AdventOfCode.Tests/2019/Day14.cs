using AdventOfCode.Days._2019._14;
...
5 BHXH, 4 VRPVC => 5 LTCX", 2210736)]
        public void Part1(string input, int totalOreExpected)
        {
            var d14 = new Days._2019._14.Day14(input);
            
            Assert.AreEqual(totalOreExpected, d14.Part1());
        }
...
5 BHXH, 4 VRPVC => 5 LTCX", 460664)]
        public void Part2(string input, int totalFuelExpected)
        {
                var d14 = new Days._2019._14.Day14(input);
            
                Assert.AreEqual(totalFuelExpected, d14.Part2());
        }
    }
}