...
public class Day3
{
    ...
    [TestCase(
        new object[] { "R75", "D30", "R83", "U83", "L12", "D49", "R71", "U7", "L72" },
    ...
    [TestCase(
        ...
        new object[] { "U98", "R91", "D20", "R16", "D67", "R40", "U7", "R15", "U6", "R7" },
        135
    )]
    public void Part1(object[] wire1, object[] wire2, int expectedDistance)
    {
        ...
        Assert.That(
            expectedDistance,
            Is.EqualTo(d3.Part1((wire1.Cast<string>().ToArray(), wire2.Cast<string>().ToArray())))
        );
    }
    ...
    public void Part2(object[] wire1, object[] wire2, int expectedDistance)
    {
        ...
        Assert.That(
            expectedDistance,
            Is.EqualTo(d3.Part2((wire1.Cast<string>().ToArray(), wire2.Cast<string>().ToArray())))
        );
    }
}
