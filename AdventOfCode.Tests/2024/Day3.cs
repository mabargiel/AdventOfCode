...
public class Day3
{
    ...
    public void Part1_should_parse_corrupted_memory_and_return_sum_of_multiplications(
        string testInput,
        int expectedResult
    )
    {
    ...
    [TestCase(
        "xmul(2,4)&do()mul[3,7]!^don't()_mul(5,5)+mul(32,64](mul(11,8)undo()?mul(8,5)do()mul(1,1)do()mul(1,1)",
        50
    )]
    public void Part2_should_parse_corrupted_memory_and_return_sum_of_multiplications_with_enablements(
        string testInput,
        int expectedResult
    )
    {
