...
public class Day4
{
    ...
    public void Part1_calculates_all_occurrences_of_xmas_word_any_direction(char[,] parsedInput, int expectedResult)
    {
    ...
    public void Part2_calculates_all_occurrences_of_x_shaped_mas_word(char[,] parsedInput, int expectedResult)
    {
